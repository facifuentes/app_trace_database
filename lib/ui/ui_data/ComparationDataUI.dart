...
class ComparationDataUI extends StatelessWidget {
  ///The detailhc is sent from hc_Patien_ui
  final String schema;
  final String idReleaseN;
  final String idReleaseA;
  ComparationDataUI({this.schema, this.idReleaseN, this.idReleaseA});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: ComparationDataListPage(
            schema: schema, idReleaseN: idReleaseN, idReleaseA: idReleaseA));
  }
}

class ComparationDataListPage extends StatefulWidget {
  final String schema;
  final String idReleaseN;
  final String idReleaseA;
  ComparationDataListPage({this.schema, this.idReleaseN, this.idReleaseA});

  @override
  _ComparationDatatate createState() => _ComparationDatatate(
      schema: schema, idReleaseN: idReleaseN, idReleaseA: idReleaseA);
}

class _ComparationDatatate extends State<ComparationDataListPage> {
  final String schema;
  final String idReleaseN;
  final String idReleaseA;
  _ComparationDatatate({this.schema, this.idReleaseN, this.idReleaseA});
  ...
  initState() {
    ...
    consultBloc.getDataComparation(schema, idReleaseN, idReleaseA);
  }
          ...
          IconButton(
            ...
            onPressed: () => _warnCreateBaseLine().then(
              (response) {
                if (response) {
                  consultBloc
                      .updateDataBaseLine(schema, idReleaseN, idReleaseA)
